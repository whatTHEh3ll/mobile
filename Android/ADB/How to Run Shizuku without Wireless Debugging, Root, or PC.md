...
1. On the other hand, connect the Type-C of the USB cable to the primary device.![usb otg](https://droidwin.com/wp-content/uploads/2025/07/usb-otg.webp)
   Secondary Device will act as a ‘PC’
1. Then enable USB Debugging on your main device. Also, enable ‘Disable Permission Monitoring’ if you’re on OnePlus.![OxygenOS 15 Android 15 OnePlus 9R](https://droidwin.com/wp-content/uploads/2025/01/usb-debugging-OxygenOS-15-Android-15-OnePlus-9R.jpg)
1. Likewise, install the Brevent and Shizuku apps on your main device.
1. Then open the browser on your secondary device and head over to brevent.sh.
1. Now tap on ‘Connect Device, Then Activate’. Choose your device from the list and hit Connect.![Run Shizuku without Wireless Debugging, Root, PC](https://droidwin.com/wp-content/uploads/2025/07/brevent-connect-device.webp)
   Run Shizuku without Wireless Debugging, Root, PC
1. Likewise, you might get a USB Debugging connection on your main device, tap OK.
1. The Brevent app will then automatically launch on your main device. Tap on Launch Brevent.
1. On the secondary device, you should now get the OK message. When that happens, you may remove the secondary device.![Run Shizuku without Wireless Debugging, Root, PC](https://droidwin.com/wp-content/uploads/2025/07/brevent-connection-sucessful.webp)
1. Now launch Shizuku on your main device, scroll to Start by connecting to a computer, and tap on View Command > Copy Code.
1. Launch Brevent, tap on the hamburger menu, and select Exec Command.
1. Then paste the command there and hit Enter [remove adb shell from the beginning]. The command should look something like this:
   ```
   sh /storage/emulated/0/Android/data/moe.shizuku.privileged.api/start.sh
   ```
1. Finally, launch Shizuku, and it should now be up and running in the ADB Mode.
